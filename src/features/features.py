"""Authoritative pairwise feature extraction module ported from project-branch1.

Preserves Anmol's tested feature calculations, text/numeric comparisons,
character n-grams, rare token overlap, dice similarity, and quality scoring.
"""
