"""Streaming evaluation of candidate retrieval using candidate diagnostics."""
...
from src.blocking.candidate_pipeline import CandidatePipeline
...
def evaluate_pipeline(
    ...
    by candidate diagnostics (literal S2-/S3- prefixes). Each stream entry counts
    as one S1 row, including repeated records and zero-truth rows. Errors propagate.

    Retains one candidate-count integer per row for linear percentiles.
